...
import siwakorn.homework.faa.database.Database
...
class ContactFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val viewModelFactory = GContactViewModelFactory(dataSource, binding, application)
        val contactViewModel =
            ViewModelProvider(
                this, viewModelFactory
            ).get(GContactViewModel::class.java)
